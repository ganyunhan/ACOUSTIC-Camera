...
%cc
[rcc01,lag01]=xcorr(music_delay01,music_src,16);
[rcc02,lag02]=xcorr(music_delay02,music_src,16);
[rcc03,lag03]=xcorr(music_delay03,music_src,16);
[rcc04,lag04]=xcorr(music_delay04,music_src,16);
[rcc05,lag05]=xcorr(music_delay05,music_src,16);
[rcc06,lag06]=xcorr(music_delay06,music_src,16);
...
real_dis01=((dis_s1)-(dis_s0));
real_dis02=((dis_s2)-(dis_s0));
real_dis03=((dis_s3)-(dis_s0));
real_dis04=((dis_s4)-(dis_s0));
real_dis05=((dis_s5)-(dis_s0));
real_dis06=((dis_s6)-(dis_s0));

error1=(dist01-real_dis01);
error2=(dist02-real_dis02);
error3=(dist03-real_dis03);
error4=(dist04-real_dis04);
error5=(dist05-real_dis05);
error6=(dist06-real_dis06);
